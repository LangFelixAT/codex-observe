...
The real-log parser feedback loop cannot proceed until a human explicitly selects a private local input path. Use `docs/REAL_LOG_FEEDBACK.md` before deriving fixtures from real sessions, and do not commit raw logs or unreviewed redacted output.
...
- Human-reviewed redacted fixture gaps from `docs/REAL_LOG_FEEDBACK.md`.
