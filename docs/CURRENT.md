...
2. Inspect the Overview operator briefing, triage, comparison quick-read card, report and comparison download controls, diagnostics, cost-share metric cards, Agent detail thread brief, Timeline & jumps, Tools quick read, Duplication, and Raw tables.
