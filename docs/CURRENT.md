...
2. Inspect the Overview operator briefing, triage, report and comparison download controls, diagnostics, cost-share metric cards, Agent detail, Timeline & jumps, Tools, Duplication, and Raw tables.
