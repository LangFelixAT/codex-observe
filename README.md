...
2. Inspect the Overview operator briefing, Overview triage card, diagnostics, and cost-share metrics, Agent detail, Timeline & jumps, Tools, Duplication, and Raw tables tabs to see how Codex Observe explains cost and context growth.
