...
Open <http://127.0.0.1:8501>. The first dashboard viewport answers three questions before showing detailed metrics: the primary risk signal, the best next habit, and the proof target for the next run.
