...
- Desktop screenshot:
- Narrow screenshot:
- Visual QA manifest: schema-versioned, path-safe `.artifacts/visual/visual-qa-manifest.json` with validated manifest evidence, referenced screenshot files, layout review, sidebar risk labels, expected high-risk metric card evidence, comparison review-path and metric delta evidence, report-and-comparison-download-control evidence, and operator-briefing evidence
